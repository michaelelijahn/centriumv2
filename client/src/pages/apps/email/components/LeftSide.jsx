...
const LeftSide = ({ totalUnreadEmails, showAllEmails, showStarredEmails, toggleComposeModal }) => {
	return (
		<>
			...
			<div className="email-menu-list mt-3">
				...
				>
					<i className="ri-inbox-line me-2"></i>Inbox
					<span className="badge badge-danger-lighten float-end ms-2">
						{totalUnreadEmails}
					</span>
				</Link>
				...
				<Link to="/apps/email/inbox">
					<i className="ri-article-line me-2"></i>Draft
