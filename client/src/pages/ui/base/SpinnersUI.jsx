	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted mb-4">
					You can go for growing spinner as well. While it doesn’t technically spin, it
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted mb-4">
					All standard visual variants are available for both animation styles by setting
					the <code>variant</code> property.
				</p>
				...
				{extendedColorVariants.map((color, index) => {
					return (
						<Spinner key={index.toString()} className="m-2" type="grow" color={color} />
					);
				})}
			</Card.Body>
		</Card>
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted mb-4">
					Add <code>size</code> attribute to make spinner with sizes including lg, md or
					sm.
				</p>
				<Row>
