					...
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Use <code>Collapse</code> component to create accordions. The
								details documentation is available
								<Link
									rel="noreferrer"
									to={{
										pathname:
											'https://react-bootstrap-v5.netlify.app/utilities/transitions/',
									}}
									target="_blank"
								>
									here
				...
				<Col xl={6}>
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Collapse provides the way to toggle the visibility of any content or
								element.
							</p>
							<p>
				...
				<Col xl={6}>
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Multiple <code>Button</code> or <code>Link</code> can show and hide
								an element.
							</p>
							<p>
				...
				<Col xl={6}>
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Add a collapse toggle animation to an element or component to
								transition the width instead of height.
							</p>
							<Button
								color="primary"
								className="ms-1"
