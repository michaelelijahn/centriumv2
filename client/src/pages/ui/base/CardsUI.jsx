...
import { PageBreadcrumb, Portlet } from '@/components';
					...
					<Col md={4} key={index.toString()}>
						<Card className={classNames('border', [`border-${color}`])}>
							<Card.Body>
								...
								<button className={classNames('btn', 'btn-sm', [`btn-${color}`])}>
									Button
								</button>
							</Card.Body>
						</Card>
					...
					<Col key={index.toString()} sm={6} lg={3}>
						<Card>
							...
							<Card.Body>
								...
								<button
									className={classNames('btn', 'stretched-link', 'mt-2', [
										`btn-${color}`,
									])}
								>
									Go somewhere
						...
						<Card>
							...
							<Card.Body>
								<Card.Title as="h5">
									<Link
										to=""
										className={classNames('stretched-link', [`text-${color}`])}
									>
