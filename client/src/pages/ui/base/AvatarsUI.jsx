					...
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Create and group avatars of different sizes and shapes with the css
								classes. Using Bootstrap's naming convention, you can control size
								of avatar including standard avatar, or scale it up to different
								sizes.
							</p>
						...
						<Card.Body>
							...
							<Row>
								{['md', 'lg', 'xl'].map((size, index) => {
									return <RoundedCircle key={index.toString()} size={size} />;
								})}
							</Row>
						</Card.Body>
					</Card>
				...
				<Col xxl={6}>
					<Card>
						<Card.Body>
							...
							<p className="text-muted font-14 mb-3">
								Using utilities classes of background e.g. <code>bg-*</code> allows
								you to have any background color as well.
							</p>
