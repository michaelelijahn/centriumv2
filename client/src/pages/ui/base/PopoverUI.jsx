	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Use the <code>trigger</code> attribute with value <code>focus</code> to dismiss
					popovers on the user's next click of a different element than the toggle
					element.
				</p>
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Elements with the <code>disabled</code> attribute aren’t interactive, meaning
					users cannot hover or click them to trigger a popover (or tooltip). As a
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Use the <code>trigger</code> attribute with value <code>hover</code> to show
