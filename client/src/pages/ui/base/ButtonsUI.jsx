			...
			<Card.Body>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					{(extendedColorVariants || []).map((variant, index) => {
						return (
							<Button key={index.toString()} variant={variant}>
		...
		<Card>
			<Card.Body>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					{extendedColorVariants.map((variant, index) => {
						return (
							<Button key={index.toString()} variant={'outline-' + variant}>
								{toSentenceCase(variant)}
							</Button>
						);
					})}
		...
		<Card>
			<Card.Body>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					{extendedColorVariants.map((variant, index) => {
						return (
							<Button key={index.toString()} variant={variant} className="btn-icon">
