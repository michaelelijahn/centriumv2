...
export const DistributedTimelineOps = {
	series: [
		{
			data: [
				{
...
export const MultiSeriesTimelineOpt = {
	series: [
		{
			name: 'Bob',
			data: [
...
export const AdvancedTimelineOpt = {
	series: [
		{
			name: 'Bob',
			data: [
...
export const GroupRowsTimelineOpt = {
	series: [
		// George Washington
		{
